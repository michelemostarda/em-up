...
/**
 * Defines the <i>preposition_element</i> non terminal.
 */
public class MUPrepositionElement extends DefaultNonTerminal {
     ...
     * @param name
     */
    public MUPrepositionElement(String name) {
        super(name);
    }
    ...
    public Object postcompile(TreeNode associatedNode, Object[] childrenResults) {
        ...
        final Object child0 = childrenResults[0];
        assert child0 instanceof Operation;
        return child0;
    }
