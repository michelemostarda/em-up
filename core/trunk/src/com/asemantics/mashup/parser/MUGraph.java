...
/**
 * Defines the <i>graph</i> non terminal.
 *
 * @author Michele Mostarda ( michele.mostarda@gmail.com )
 * @version $Id: MUGraph.java 444 2009-06-29 16:16:42Z michelemostarda $
 */
public class MUGraph extends DefaultNonTerminal {

    public MUGraph(String name) {
        super(name);
    }
    ...
    public Object postcompile(TreeNode associatedNode, Object[] childrenResults) {
        ...
        List<Triple> triples = (List<Triple>) childrenResults[1];
