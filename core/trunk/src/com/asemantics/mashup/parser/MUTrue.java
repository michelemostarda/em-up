...
/**
 * Defines the <i>true</i> terminal value.
 */
public class MUTrue extends DefaultTerminal {
     ...
     * @param name
     */
    public MUTrue(String name) {
        super(name);
    }

    @Override
    public Object postcompile(TreeNode associatedNode, Object[] childrenResults) {
        return new ConstArgument( BooleanValue.getTrueValue() );
    }
