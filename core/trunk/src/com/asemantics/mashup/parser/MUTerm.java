...
/**
 * Defines the <i>term</i> non terminal.
 */
public class MUTerm extends DefaultNonTerminal {
    ...
    public Object postcompile(TreeNode associatedNode, Object[] childrenResults) {
        ...
        assert
                childrenResults[0] instanceof Argument 
                ||
                childrenResults[0] instanceof Operation :
                "All terminals must be arguments: " + childrenResults[0];
        //TODO: merge the Argument and Operation interfaces on the execute / evaluate methods. 
