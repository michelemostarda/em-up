...
/**
 * Defines a generic model element.
 */
public interface ModelElement extends Validable, Unifiable {

    /**
     * Returns the list of variables defined inside this model element.
     *
