...
/**
 * Defines any exception raised during validation
 * of {@link com.asemantics.mashup.processor.unification.JsonModel}.
 */
public class JsonModelException extends RuntimeException {

    public JsonModelException(String s, Throwable throwable) {
        super(s, throwable);
    }
