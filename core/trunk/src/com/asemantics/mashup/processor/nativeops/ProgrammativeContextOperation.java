...
/**
 * Implementation of <i>ProgrammativeContext()</i> operation.
 */
public class ProgrammativeContextOperation extends NativeInvocable {

    public ProgrammativeContextOperation() {
        // Empty.
    }
    ...
    public String getShortDescription() {
        return "Returns the only programmative context.";
    }
    ...
    throws InvocationException {
        ...
        try {
            return new StringValue( context.printProgrammativeContext() );
        } catch (Exception e) {
            throw new InvocationException("Error while extrating programmative context.", e);
        }
