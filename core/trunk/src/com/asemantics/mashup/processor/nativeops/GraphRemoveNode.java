...
/**
 * Implements the <i>GRemoveNode(graph,node)</i> operation.
 * Returns a graph with given values.
 */
public class GraphRemoveNode extends NativeInvocable {
    ...
    public String getShortDescription() {
        return "Removes a node from a graph";
    }
